...
let temp = users.map((user) => {
    return { email: user.email, companyName: user.companyName };
});
console.log(temp);
//ex2
temp = users.filter((user) => user.address.zipcode.startsWith("5"));
console.log(temp);
//ex3
temp = users
...
console.log(temp);
//ex5
console.log(users.every((user) => user.city === "South Christy"));
//ex6
console.log(
